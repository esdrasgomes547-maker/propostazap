      ...
      <div className="mx-auto flex max-w-4xl items-center gap-3 px-4 py-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          <button
            ...
            className="rounded-lg p-2 text-slate-600 dark:text-slate-300 transition hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer flex items-center gap-1.5 text-xs font-medium"
          >
            {tema === 'dark' ? (
              <>
